 ...
 */
public class YuOAuth2Template extends OAuth2Template {

    private Logger log = LoggerFactory.getLogger(getClass());

    public YuOAuth2Template(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
